...
export const metadata: Metadata = {
  ...
  description: '購入希望やカスタマイズのご相談はこちらからお送りください。'
};
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-12 px-6 py-16 md:py-24">
      <header className="space-y-4">
        ...
        <h1 className="luxury-heading font-serif text-4xl md:text-5xl">お問い合わせ・購入希望</h1>
        <p className="text-sm leading-loose-jp text-ink-soft">必要事項をご入力の上、送信してください。担当より2営業日以内にご返信いたします。</p>
      </header>
